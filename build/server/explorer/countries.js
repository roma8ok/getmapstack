...
export const COUNTRIES = [
  ...
  { name: "Belarus", slug: "belarus", center: [28.0, 53.7], zoom: 6.2 },
  ...
  { name: "Canada", slug: "canada", center: [-96.0, 56.0], zoom: 3.2 },
  ...
  { name: "France", slug: "france", center: [2.6, 46.6], zoom: 5.3 },
  ...
  { name: "Germany", slug: "germany", center: [10.3, 51.2], zoom: 5.5 },
  ...
  { name: "Russia", slug: "russia", center: [95.0, 61.0], zoom: 2.6 },
